	...
	if(empty($input))
{
	...
	if (mysqli_num_rows($result) > 0) 
	{
		...
		{ 
			echo '<a  class="list-group-item list-group-item-action list-group-item-info justify-content-between" href="itemBook.php?id='.$row["itemId"].'">'. $row["itemName"]. '--- '.$row["quantity"].'';
			}
}
