                     ...
                     // output data of each row
                            while($row = $result->fetch_assoc()) {
                                ...
                                if ($itemNumber == 0){
                                    echo '
                                    <div class="itemStyle">
                                    <a  class="list-group-item list-group-item-action list-group-item-danger justify-content-between " href="itemBookCustomer.php?id='.$row["itemId"]. '">'
                                        .$row["itemName"]. '
                                    ...
                                    echo '
                                    <div class="itemStyle">
                                    <a class="list-group-item list-group-item-action justify-content-between " href="itemBookCustomer.php?id='.$row["itemId"]. '">'
                                        .$row["itemName"].'
                                        <span class="badge badge-default badge-pill"> '.$row["quantity"].'</span>
                                    </a></div>';
                                }
